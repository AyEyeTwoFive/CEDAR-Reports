...
class NumberOfArtifactsTest {
  ...
  void getResourcesPerUser() throws IOException {
    ...
    assertEquals(1, NumberOfArtifacts.getResourcesPerUser("https://repo.metadatacenter.org/folders/7f636e7c-8d35-4c3b-bd44-b09996e534cf","element"));
    assertEquals(11, NumberOfArtifacts.getResourcesPerUser("https://repo.metadatacenter.org/folders/7f636e7c-8d35-4c3b-bd44-b09996e534cf","artifact"));
  }
}